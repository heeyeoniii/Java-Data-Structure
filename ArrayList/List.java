...
public interface List<E> {
	 ...
	 * 	       리스트에 중복되는 요소가 있을 경우 {@code false} 반환, 없을 경우 {@code true} 반환
	 */	
	boolean add(E value);
	 ...
	 * @return 삭제할 요소가 없거나 삭제에 실패할 경우 {@code false} 반환, 
	 ...
	 * @return 리스트에서 처음으로 요소와 일치하는 위치 반환,
	 *         없을 경우 -1 반환
	 */
